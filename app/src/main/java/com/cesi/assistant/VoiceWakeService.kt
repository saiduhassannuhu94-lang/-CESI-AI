...
class VoiceWakeService : Service() {
    ...
    override fun onCreate() {
        ...
        getSystemService(NotificationManager::class.java).createNotificationChannel(
            NotificationChannel(CHANNEL_ID, "CESI Voice Wake", NotificationManager.IMPORTANCE_LOW)
        )
    ...
    private fun wakeCesi(spoken: String) {
        ...
        try {
            startForegroundService(Intent(this, com.cesi.assistant.core.service.CesiAssistantService::class.java).apply {
                putExtra(EXTRA_WAKE_PHRASE, spoken)
            })
        } catch (_: Exception) {}
    ...
    private fun restartSoon() {
        ...
        restarting = true
        handler.postDelayed({ restarting = false; startWakeListening() }, RESTART_DELAY_MS)
    }
